    ...
    <div>
      <div className="max-w-7xl mx-auto px-4 pb-18">
        ...
        <div className="mt-10">
          {isSearching && (
            <div className="flex flex-col items-center justify-center py-16">
              ...
              <div className="relative">
                ...
                <div className="w-14 h-14 border-4 border-purple-600 border-t-transparent rounded-full animate-spin absolute top-0 left-0"></div>
              </div>
          ...
          {isSearching ? null : filteredApps.length > 0 ? (
