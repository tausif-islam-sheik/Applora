    ...
    <div class="card bg-base-100 shadow-md rounded-xl cursor-pointer">
      ...
      <div class="px-4 pb-4">
        ...
        <div class="flex items-center justify-between mt-3">
          <div class="flex items-center gap-1 text-green-600 text-xs font-medium p-2 rounded-lg bg-green-100">
            <svg
          ...
          <div class="flex items-center gap-1 bg-orange-100 text-orange-500 px-2 py-1 rounded-md text-xs font-medium">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="w-4 h-4"
              fill="currentColor"
