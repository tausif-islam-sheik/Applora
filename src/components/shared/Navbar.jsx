    ...
    <div className="navbar bg-base-100 shadow-sm md:px-10">
      <div className="navbar-start">
        ...
        <Link to={"/"} className="flex items-center gap-1 md:text-xl">
          ...
          <span className="uppercase font-bold bg-gradient-to-r from-purple-500 to-indigo-500 bg-clip-text text-transparent">
            Applora
          </span>
        </Link>
      </div>
      ...
      <div className="navbar-end">
        <Link to={"https://github.com/tausif-islam-sheik/Applora"}>
